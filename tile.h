...
public:
	...
	virtual bool is_allowed(Resource&) const;
	virtual bool is_allowed(Resource::ResourceName&) const;
	virtual bool is_allowed(Feature&) const;
	virtual bool is_allowed(Feature::FeatureName&) const;
