...
bool Mountain::set_resource(const Resource &res ) {
    return false;
}

bool Mountain::set_feature(const Feature &feat) {
    this->feat = feat;
    return false;
}

Resource& Mountain::get_rand_resource(const Resource::ResourceType type,
        int rnum) const {
