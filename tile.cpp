...
Tile::Tile() : owner(), x(0), y(0), feat_count(0), res_count(0),
...
// TODO check if when added and neighbours get instantiated later
...
vector<CoOrd> Tile::get_all_neighbours() {
    if (this->all_nei.size() != 0)
        return this->all_nei;
    if (this->nei_west.get_x() != CoOrd::oob && this->nei_west.get_y() != CoOrd::oob)
    	this->all_nei.push_back(this->nei_west);
    if (this->nei_nwest.get_x() != CoOrd::oob && this->nei_nwest.get_y() != CoOrd::oob)
	    this->all_nei.push_back(this->nei_nwest);
	if (this->nei_swest.get_x() != CoOrd::oob && this->nei_swest.get_y() != CoOrd::oob)
	    this->all_nei.push_back(this->nei_swest);
	if (this->nei_east.get_x() != CoOrd::oob && this->nei_east.get_y() != CoOrd::oob)
	    this->all_nei.push_back(this->nei_east);
	if (this->nei_seast.get_x() != CoOrd::oob && this->nei_seast.get_y() != CoOrd::oob)
	    this->all_nei.push_back(this->nei_seast);
	if (this->nei_neast.get_x() != CoOrd::oob && this->nei_neast.get_y() != CoOrd::oob)
...
bool Tile::is_allowed(Feature &feat) const {
...
bool Tile::is_allowed(Feature::FeatureName &fn) const {
	for (int i = 0; i < feat_count; ++i) {
...
bool Tile::is_allowed(Resource &res) const {
...
bool Tile::is_allowed(Resource::ResourceName &rn) const {
	for (int i = 0; i < res_count; ++i) {
...
bool Tile::set_feature(Feature &feat) {
	// Abstract method
	return false;
}

bool Tile::set_resource(Resource &res) {
	return false;
}
