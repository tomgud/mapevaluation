...
#include <iostream>
Feature::Feature()
    : name(Feature::NO_FEAT),
    yield(0, 0, 0), mv_cost(0), combat_mod(0),
    singleton(false), impassable(false) {
}


Feature::Feature(string str_name)
    : name(NO_FEAT), yield(0, 0, 0),
